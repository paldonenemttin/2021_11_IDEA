...
public class LoginService implements UserDetailsService {
    ...
    private final String encPassword = "$2a$04$VC0uf.BY9ujLsbPwqvlfMOmzfTwzDGPx4zNfEHi8wJt0TDJRh203C";
    @Override
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //      DB 에 없으면 강제로 Exception 을 발생하여
        //      security 에게 알려준다
        if(userVO == null){
            log.debug("{} username 없음", username);
            throw new UsernameNotFoundException(username + "사용자 정보 없음");
        }
